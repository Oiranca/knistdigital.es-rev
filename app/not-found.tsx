      ...
      <main id="main" tabIndex={-1}>
        ...
        >
          ...
          >
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center gap-2">
                ...
                <span className={light ? 'text-[#1a1b1e]' : 'text-cs-fg'}>GET /unknown</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-[#ff9ec0]">✗</span>
                <span className="text-[#ff9ec0]">404 Not Found — Page does not exist</span>
              </div>
              <div className="flex items-center gap-2 flex-wrap">
                <span className={light ? 'text-[#555]' : 'text-cs-fg-soft'}>→</span>
                <span className={light ? 'text-[#555]' : 'text-cs-fg-soft'}>Try:</span>
                <Link href="/" className="no-underline" style={{ color: 'var(--color-kd-pistacho)' }}>
                  /
                </Link>
                <span className={light ? 'text-[#555]' : 'text-cs-fg-soft'}>·</span>
                <Link href="/services" className="no-underline" style={{ color: 'var(--color-kd-pistacho)' }}>
                  /servicios
                </Link>
                <span className={light ? 'text-[#555]' : 'text-cs-fg-soft'}>·</span>
                <Link href="/contact" className="no-underline" style={{ color: 'var(--color-kd-pistacho)' }}>
                  /contacto
                </Link>
              </div>
            </div>
          ...
          <p className={`m-0 max-w-[50ch] text-[15px] leading-relaxed ${light ? 'text-[#555]' : 'text-cs-fg-soft'}`}>
            Estamos tejiendo el resto de nuestra web con mucho cariño, así que pronto tendremos esta página lista. Si tienes alguna sugerencia, ¡nos encantaría escucharla!
          </p>
